...
export const generateDroppedItem = (): string | undefined => {
  // Disabled: special development drops
  // This function previously forced specific items to drop for testing
  // Now it returns undefined so mobs drop their normal loot table items
  return undefined;
};
