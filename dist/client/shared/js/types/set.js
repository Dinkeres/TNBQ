...
export var setDescription = {
    immortal: "wearing the full Immortal set grants you a second life upon death if the spectral aura is active, the aura reload time depends on your set level.",
