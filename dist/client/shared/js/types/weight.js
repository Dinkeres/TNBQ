...
export var attackBonusPercentsFromWeightMap = {
    light: -15,
    normal: 0,
    heavy: 25,
    "Super heavy": 35,
};
export var getAttackSpeedBonusFromStringMap = {
    light: 20,
    normal: 0,
    heavy: -15,
    "Super heavy": -20,
};
export var getWeaponWeightbyKind = function (kind) {
    var weights = ["light", "normal", "heavy", "Super heavy"];
