...
import { calculateAttackSpeedCap, calculateExtraGoldCap, calculateMagicFindCap, calculateResistance, DEFAULT_ATTACK_ANIMATION_SPEED, DEFAULT_ATTACK_SPEED, elements, enchantToDisplayMap, getRandomElement, getResistance, mobEnchant, mobResistance, PLAYER_MAX_EXTRA_GOLD, PLAYER_MAX_MAGIC_FIND, PLAYER_MAX_RESISTANCES, resistanceToDisplayMap, } from "./types/resistance";
import { getHighestSocketRequirement, getJewelRequirement, getJewelSkinIndex, getRune, getRuneFromItem, getRuneNameFromItem, getRunesBonus, getRunewordBonus, isRune as isRuneImport, RUNE, RuneByKind, runeKind, RuneList, Runewords, } from "./types/rune";
import { kindAsStringToSet, setBonus as setBonusImport, setItems, setItemsNameMap } from "./types/set";
import { attackSkillDelay, attackSkillDurationMap, attackSkillToDamageType, attackSkillToResistanceType, attackSkillType, attackSkillTypeAnimationMap, calculateSkillTimeout, defenseSkillDelay, defenseSkillDurationMap, defenseSkillTypeAnimationMap, getAttackSkill, getDefenseSkill, skillToNameMap, } from "./types/skill";
import { attackBonusPercentsFromWeightMap, getAttackSpeedBonusFromStringMap, getWeaponWeightbyKind, } from "./types/weight";
export var Types = {
    Store: {
        EXPANSION1: 1,
        SCROLLUPGRADEHIGH: 2,
...
Types.Entities.Weapons = __spreadArray(__spreadArray(__spreadArray(__spreadArray([], Types.Entities.LightWeapons, true), Types.Entities.NormalWeapons, true), Types.Entities.HeavyWeapons, true), Types.Entities.SuperHeavyWeapons, true);
...
Types.getGemNameFromKind = function (kind) {
    var _a;
    var gems = (_a = {},
        _a[Types.Entities.GEMRUBY] = "Ruby",
        _a[Types.Entities.GEMEMERALD] = "Emerald",
        _a[Types.Entities.GEMAMETHYST] = "Amethyst",
        _a[Types.Entities.GEMTOPAZ] = "Topaz",
        _a[Types.Entities.GEMSAPPHIRE] = "Sapphire",
        _a);
...
Types.getArtifactNameFromKind = function (kind) {
    var _a;
    var artifact = (_a = {},
        _a[Types.Entities.RAIBLOCKSTL] = "Raiblocks top left",
        _a[Types.Entities.RAIBLOCKSTR] = "Raiblocks top right",
        _a[Types.Entities.RAIBLOCKSBL] = "Raiblocks bottom left",
        _a[Types.Entities.RAIBLOCKSBR] = "Raiblocks bottom right",
        _a);
    return artifact[kind] || kind;
};
export var petKindToPetMap = (_a = {},
    _a[Types.Entities.PETDINO] = Types.Entities.PET_DINO,
    _a[Types.Entities.PETBAT] = Types.Entities.PET_BAT,
    _a[Types.Entities.PETCAT] = Types.Entities.PET_CAT,
    _a[Types.Entities.PETDOG] = Types.Entities.PET_DOG,
    _a[Types.Entities.PETAXOLOTL] = Types.Entities.PET_AXOLOTL,
    _a[Types.Entities.PETFOX] = Types.Entities.PET_FOX,
    _a[Types.Entities.PETTURTLE] = Types.Entities.PET_TURTLE,
    _a[Types.Entities.PETDUCK] = Types.Entities.PET_DUCK,
    _a[Types.Entities.PETDEER] = Types.Entities.PET_DEER,
    _a[Types.Entities.PETREINDEER] = Types.Entities.PET_REINDEER,
    _a[Types.Entities.PETMONKEY] = Types.Entities.PET_MONKEY,
    _a[Types.Entities.PETHELLHOUND] = Types.Entities.PET_HELLHOUND,
    _a[Types.Entities.PETDRAGON] = Types.Entities.PET_DRAGON,
    _a[Types.Entities.PETMOUSE] = Types.Entities.PET_MOUSE,
    _a[Types.Entities.PETHEDGEHOG] = Types.Entities.PET_HEDGEHOG,
    _a);
export var kinds = {
...
Types.isSuperUnique = function (itemName) {
    return [
        "ringnecromancer",
        "ringraistone",
        "ringfountain",
...
Types.isHelm = function (kindOrString) {
...
Types.isCape = function (kindOrString) {
    if (typeof kindOrString === "number") {
...
Types.isShield = function (kindOrString) {
    if (typeof kindOrString === "number") {
...
Types.isMiniBoss = function (_a) {
    var kind = _a.kind, _b = _a.enchants, enchants = _b === void 0 ? [] : _b;
    return (!Types.isBoss(kind) &&
...
Types.isScroll = function (kindOrString) {
    if (typeof kindOrString === "number") {
        ...
        return kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("scroll");
    }
};
Types.isStone = function (kindOrString) {
    if (typeof kindOrString === "number") {
        return [
        ...
        return (kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("stone")) || (kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("soulstone"));
    }
};
Types.isBar = function (kindOrString) {
    if (typeof kindOrString === "number") {
        return [
        ...
        return ((kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("barbronze")) ||
            (kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("barsilver")) ||
            (kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("bargold")) ||
            (kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("barplatinum")));
    }
};
Types.isJewel = function (kindOrString) {
    if (typeof kindOrString === "number") {
        return [Types.Entities.JEWELSKULL].includes(kindOrString);
    }
    else {
        return kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("jewel");
    }
};
Types.isChest = function (kindOrString) {
    if (typeof kindOrString === "number") {
        return [
        ...
        return (kindOrString === null || kindOrString === void 0 ? void 0 : kindOrString.startsWith("chest")) || kindOrString.includes("present");
    }
};
Types.isConsumable = function (kindOrString) {
    if (typeof kindOrString === "number") {
...
Types.isUniqueRing = function (kindOrString, bonus) {
...
Types.isUniqueAmulet = function (kindOrString, bonus) {
    if (bonus === void 0) { bonus = []; }
...
Types.isUniqueJewel = function (kindOrString, bonus, level) {
    if (bonus === void 0) { bonus = []; }
    if (!Types.isJewel(kindOrString))
        return false;
    return ((level === 1 && bonus.length === 2) ||
        (level === 2 && bonus.length === 3) ||
        (level === 3 && bonus.length === 4) ||
        (level === 4 && bonus.length === 5) ||
        (level === 5 && bonus.length === 6));
};
Types.isStaticChest = function (kind) {
...
Types.isQuantity = function (kindOrString) {
    return (Types.isScroll(kindOrString) ||
...
Types.isNotStackableItem = function (kindOrString) {
    if (!kindOrString)
        return false;
    if (typeof kindOrString === "number") {
...
Types.isEquipableItem = function (kind) {
...
Types.isSocketItem = function (kind) {
...
Types.isPetItem = function (kindOrString) {
    if (!kindOrString)
        return false;
    if (typeof kindOrString === "number") {
        return [
...
Types.getKindFromString = function (kind) { var _a; return (_a = kinds[kind]) === null || _a === void 0 ? void 0 : _a[0]; };
...
Types.getRandomItemKind = function () {
    var all = _.union(this.rankedWeapons, this.rankedArmors), forbidden = [Types.Entities.DAGGER, Types.Entities.CLOTHARMOR, Types.Entities.HELMCLOTH], itemKinds = _.difference(all, forbidden), i = Math.floor(Math.random() * _.size(itemKinds));
    return itemKinds[i];
};
...
Types.getBonus = function (rawBonus, level) {
    var minDamagePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var maxDamagePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var attackDamagePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var healthPerLevel = [1, 3, 6, 9, 12, 15, 20, 28, 35, 45];
    var magicDamagePerLevel = [1, 2, 3, 4, 6, 8, 12, 18, 26, 40];
    var defensePerLevel = [1, 2, 4, 6, 8, 11, 15, 22, 28, 40];
    var absorbPerLevel = [2, 4, 6, 8, 10, 13, 15, 18, 22, 28];
    var expPerLevel = [1, 2, 4, 6, 8, 10, 13, 17, 24, 30];
    var regenerateHealthPerLevel = [1, 2, 3, 6, 9, 12, 15, 20, 25, 40];
    var criticalHitPerLevel = [1, 1, 2, 3, 4, 6, 8, 11, 15, 20];
    var blockChancePerLevel = [1, 1, 2, 3, 4, 6, 8, 11, 15, 20];
    var magicFindPerLevel = [1, 2, 3, 5, 7, 9, 12, 16, 22, 30];
    var attackSpeedPerLevel = [1, 2, 3, 4, 6, 8, 10, 15, 20, 30];
    var drainLifePerLevel = [1, 3, 6, 9, 12, 16, 20, 25, 32, 45];
    var flameDamagePerLevel = [3, 6, 9, 12, 15, 20, 28, 35, 45, 60];
    var lightningDamagePerLevel = [1, 3, 6, 9, 12, 16, 20, 25, 32, 45];
    var pierceDamagePerLevel = [3, 6, 9, 12, 15, 20, 28, 35, 45, 60];
    var highHealthPerLevel = [10, 20, 30, 40, 50, 70, 100, 140, 200, 280];
    var coldDamagePerLevel = [1, 3, 5, 7, 10, 13, 16, 20, 26, 34];
    var freezeChancePerLevel = [1, 1, 2, 3, 4, 6, 8, 11, 15, 20];
    var reduceFrozenChancePerLevel = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50];
    var magicResistancePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var flameResistancePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var lightningResistancePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var coldResistancePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var poisonResistancePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var spectralResistancePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var magicDamagePercentPerLevel = [1, 2, 3, 5, 7, 10, 15, 19, 26, 35];
    var flameDamagePercentPerLevel = [1, 2, 3, 5, 7, 10, 15, 19, 26, 35];
    var lightningDamagePercentPerLevel = [1, 2, 3, 5, 7, 10, 15, 19, 26, 35];
    var coldDamagePercentPerLevel = [1, 2, 3, 5, 7, 10, 15, 19, 26, 35];
    var poisonDamagePercentPerLevel = [1, 3, 6, 9, 12, 15, 20, 28, 35, 45];
    var allResistancePerLevel = [1, 2, 3, 4, 5, 7, 10, 15, 20, 28];
    var preventRegenerateHealthPerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var poisonDamagePerLevel = [1, 3, 6, 9, 12, 16, 20, 25, 32, 45];
    var skillTimeoutPerLevel = [1, 2, 4, 6, 8, 10, 13, 17, 24, 30];
    var lowerMagicResistancePerLevel = [1, 2, 4, 6, 9, 13, 17, 22, 28, 36];
    var lowerFlameResistancePerLevel = [1, 2, 4, 6, 9, 13, 17, 22, 28, 36];
    var lowerLightningResistancePerLevel = [1, 2, 4, 6, 9, 13, 17, 22, 28, 36];
    var lowerColdResistancePerLevel = [1, 2, 4, 6, 9, 13, 17, 22, 28, 36];
    var lowerPoisonResistancePerLevel = [1, 2, 4, 6, 9, 13, 17, 22, 28, 36];
    var lowerAllResistancePerLevel = [1, 2, 3, 5, 7, 9, 12, 16, 22, 30];
    var extraGoldPerLevel = [1, 2, 4, 7, 12, 15, 18, 22, 30, 40];
    var bonusPerLevel = [
        minDamagePerLevel,
        maxDamagePerLevel,
    ...
    var bonus = {};
    if (!rawBonus || !Array.isArray(rawBonus))
        return {};
    for (var i = 0; i < rawBonus.length; i++) {
        var type = Types.bonusType[rawBonus[i]];
        var stats = bonusPerLevel[rawBonus[i]][level - 1];
        if (!bonus[type]) {
            bonus[type] = 0;
        }
        bonus[type] += stats;
...
Types.getSetBonus = function (currentSet, count) {
    if (count === void 0) { count = 0; }
    var setBonus = [];
    if (count < 2)
        return setBonus;
    Object.entries(Types.setBonus[currentSet]).map(function (_a, i) {
        var type = _a[0], stats = _a[1];
        var index = Types.bonusType.indexOf(type);
        if (index !== -1 && i <= count - 1) {
            var description = Types.getBonusDescriptionMap[index].replace("#", stats);
            setBonus.push({
                type: type,
                stats: stats,
...
Types.getPartyBonus = function (rawBonus, level) {
    var attackDamagePerLevel = [1, 2, 3, 4, 6, 8, 11, 15, 20, 30];
    var defensePerLevel = [1, 2, 3, 4, 6, 8, 11, 15, 20, 30];
    var expPerLevel = [1, 2, 3, 4, 6, 8, 11, 15, 20, 30];
    var minDamagePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var maxDamagePerLevel = [1, 2, 3, 4, 5, 6, 8, 12, 18, 30];
    var healthPerLevel = [1, 3, 6, 9, 12, 15, 20, 28, 35, 45];
    var magicDamagePerLevel = [1, 2, 3, 4, 6, 8, 12, 18, 26, 40];
    var allResistancePerLevel = [1, 2, 3, 4, 6, 8, 11, 14, 19, 25, 32];
    var extraGoldPerLevel = [1, 2, 3, 4, 6, 8, 11, 14, 19, 25, 32];
    var bonusPerLevel = [
        attackDamagePerLevel,
        defensePerLevel,
        expPerLevel,
    ...
    if (!rawBonus || !Array.isArray(rawBonus))
        return bonus;
    for (var i = 0; i < rawBonus.length; i++) {
        var type = Types.partyBonusType[rawBonus[i]];
        var stats = bonusPerLevel[rawBonus[i]][level - 1];
        var description = Types.getPartyBonusDescriptionMap[rawBonus[i]].replace("#", stats);
        bonus.push({
            type: type,
            stats: stats,
            description: description,
...
Types.getAttributesBonus = function (attributes, level) {
    var bonus = Object.entries(attributes).map(function (_a) {
        var type = _a[0], stats = _a[1];
        var description = Types.getBonusDescriptionMap[Types.bonusType.findIndex(function (t) { return t === type; })].replace("#", stats);
...
Types.getFrozenTimePerLevel = function (itemLevel) { return itemLevel * 250; };
Types.bonusCap = {
...
Types.getUpgradeSuccessRates = function () {
    return [100, 100, 90, 80, 55, 30, 7, 4, 1];
};
Types.getLuckySlotSuccessRateBonus = function () {
    return [0, 0, 10, 8, 6, 5, 3, 2, 1];
};
Types.getBlessedSuccessRateBonus = function () {
    return [0, 0, 10, 8, 6, 5, 3, 2, 1];
};
Types.getTransmuteSuccessRate = function (item, bonus, isBlessed) {
    ...
    var isUniqueRing = isRing && isUnique;
    var isUniqueAmulet = isAmulet && isUnique;
    var isUniqueBelt = isBelt && isUnique;
    var isUniqueCape = isCape && isUnique;
    var isUniqueShield = isShield && isUnique;
    var isUniqueWeapon = isWeapon && isUnique;
    var isUniqueArmor = isArmor && isUnique;
    var isUniqueHelm = isHelm && isUnique;
    var isUniquePet = isPet && isUnique;
    var uniqueSuccessRateMap = {
        goldensword: 20,
        blueaxe: 18,
        bluemorningstar: 18,
        frozensword: 15,
    ...
    var transmuteSuccessRate = isBlessed ? 99 : 75;
    if (isUniqueRing ||
        isUniqueAmulet ||
        isUniqueBelt ||
        isUniqueCape ||
        ...
        isUniqueArmor ||
        isUniqueHelm) {
        return { transmuteSuccessRate: transmuteSuccessRate, uniqueSuccessRate: 100 };
    }
    else if (!isUnique && uniqueSuccessRateMap[item]) {
        return __assign({ uniqueSuccessRate: uniqueSuccessRateMap[item] + (isBlessed ? 2 : 0) }, (isRing || isAmulet || isCape || isPet || isShield || isWeapon || isHelm || isArmor || isBelt
            ? { transmuteSuccessRate: transmuteSuccessRate }
            : null));
    }
    return null;
};
Types.getArmorDefense = function (armor, level, isUnique, isSuperior) {
    if (!armor || !level)
        return 0;
    var itemClass = Types.getItemClass(armor, level);
    var itemClassRank = Types.itemClassRank[itemClass];
    var defense = kinds[armor][4] +
        (isUnique ? itemClassRank + 1 : 0) +
        (isSuperior ? Types.itemClassRankSuperiorBonus[itemClass] : 0);
    var defensePercentPerLevel = [100, 105, 110, 120, 130, 145, 160, 180, 205, 235];
    var defenseBonus = level >= 7 ? level - 6 : 0;
    return Math.ceil((defense + defenseBonus) * (defensePercentPerLevel[level - 1] / 100));
};
Types.getArmorHealthBonus = function (level) {
    if (!level)
        return 0;
    var healthBonusPerLevel = [1, 3, 6, 9, 12, 15, 20, 28, 35, 45];
    return healthBonusPerLevel[level - 1];
};
Types.getWeaponDamage = function (weapon, level, isUnique, isSuperior) {
    var itemClass = Types.getItemClass(weapon, level);
    var itemClassRank = Types.itemClassRank[itemClass];
    var weight = getWeaponWeightbyKind(kinds[weapon][0]);
    var attackBonusPercentByWeight = attackBonusPercentsFromWeightMap[weight];
    var damage = kinds[weapon][4] +
        (isUnique ? itemClassRank + 1 : 0) +
        (isSuperior ? Types.itemClassRankSuperiorBonus[itemClass] : 0);
    var damagePercentPerLevel = [100, 105, 110, 120, 130, 145, 160, 185, 215, 255];
    var damageBonus = level >= 7 ? Math.ceil((level - 6) * 2) : 0;
    var totalDamage = (damage + damageBonus) * (damagePercentPerLevel[level - 1] / 100);
    totalDamage = Math.ceil(totalDamage * (1 + attackBonusPercentByWeight / 100));
    return totalDamage;
};
Types.getWeaponMagicDamage = function (level) {
    var magicDamagePerLevel = [1, 3, 5, 8, 11, 15, 18, 25, 35, 50];
    return magicDamagePerLevel[level - 1];
};
Types.isBaseHighClassItem = function (item) {
    var baseLevel = kinds[item][3];
    return baseLevel >= 10;
};
Types.isBaseLegendaryClassItem = function (item) {
    var baseLevel = kinds[item][3];
    return baseLevel >= 48;
};
Types.getItemClass = function (item, level) {
    var baseLevel = Types.getItemBaseLevel(item);
    var isPet = Types.isPetItem(item);
    if (isPet || level >= 9) {
        return "legendary";
    }
...
Types.getItemClassFromBaseLevel = function (level, baseLevel) {
    var itemClass;
    if (baseLevel < 5) {
        if (!level || level <= 5) {
            itemClass = "low";
...
Types.getItemBaseLevel = function (item) {
    return kinds[item][3];
};
Types.getItemRequirement = function (item, level) {
    var baseLevel = Types.getItemBaseLevel(item);
    var multiplier = Types.getItemClass(item, level) === "high" ? 1.5 : 1;
    var requirement = Math.floor(baseLevel + level * multiplier);
    return requirement;
};
Types.isSuperior = function (rawBonus) {
    var _a;
    return (_a = toArray(rawBonus)) === null || _a === void 0 ? void 0 : _a.includes(43);
};
Types.isUnique = function (item, rawBonus, level) {
    ...
    if (Array.isArray(bonus) && bonus.length) {
        bonus = bonus.filter(function (oneBonus) { return oneBonus !== 43; });
    }
    if (isRing) {
...
Types.getJewelBonus = function (rawSockets) {
    var combinedBonus = {};
    rawSockets === null || rawSockets === void 0 ? void 0 : rawSockets.forEach(function (rawSocket) {
        if (typeof rawSocket !== "string")
            return;
        var _a = rawSocket.split("|"), item = _a[0], rawLevel = _a[1], rawBonus = _a[2];
        if (!Types.isJewel(item))
            return;
        var level = Number(rawLevel);
        var bonus = Types.getBonus(JSON.parse(rawBonus), level);
        Object.entries(bonus).forEach(function (_a) {
...
Types.combineBonus = function (bonus1, bonus2) {
    return Object.entries(bonus2).reduce(function (acc, _a) {
        var key = _a[0], value = _a[1];
        acc[key] = (acc[key] || 0) + value;
        return acc;
    }, __assign({}, bonus1));
};
Types.getItemDetails = function (_a) {
    var item = _a.item, level = _a.level, rawBonus = _a.rawBonus, rawSocket = _a.rawSocket, rawSkill = _a.rawSkill, playerBonus = _a.playerBonus, amount = _a.amount;
    var isWeapon = Types.isWeapon(item);
    var weight = isWeapon ? Types.getWeaponWeightbyKind(Types.getKindFromString(item)) : null;
    var isHelm = Types.isHelm(item);
    var isArmor = Types.isArmor(item);
    var isRing = Types.isRing(item);
    var isAmulet = Types.isAmulet(item);
    ...
    var isCape = Types.isCape(item);
    var isShield = Types.isShield(item);
    var isUnique = Types.isUnique(item, rawBonus, level);
    var isRune = Types.isRune(item);
    var isJewel = Types.isJewel(item);
    var isStone = Types.isStone(item);
    var rune = isRune ? Types.getRuneFromItem(item) : null;
    var isSocket = rawSocket === null || rawSocket === void 0 ? void 0 : rawSocket.length;
    var socketRequirement = isSocket ? Types.getHighestSocketRequirement(rawSocket) : null;
    var jewelRequirement = isJewel ? Types.getJewelRequirement(rawBonus) : null;
    var goldAmount = amount || getGoldAmountFromSoldItem({ item: item, level: level, socket: rawSocket });
    var name = Types.getDisplayName(item, isUnique);
    var magicDamage = 0;
    var healthBonus = 0;
    var bonus = {};
    var skill = null;
    ...
    var runeBonus = [];
    var runeRank = null;
    var isRuneword = false;
    var isSuperior = Array.isArray(rawBonus) ? rawBonus.includes(43) : false;
    if (isSuperior) {
        rawBonus = rawBonus.filter(function (oneBonus) { return oneBonus !== 43; });
    }
    var type = "item";
    var itemClass = isJewel
    ...
    var description = isRune ? Types.itemDescription.rune : Types.itemDescription[item];
    if (rawBonus) {
        if (isCape) {
    ...
    if (isSocket) {
        var _b = Types.getRunewordBonus({ isUnique: isUnique, socket: rawSocket, type: type }), runeword = _b.runeword, runewordBonus = _b.runewordBonus;
    ...
    return __assign(__assign(__assign({ item: item, weight: weight, name: name, type: type, isUnique: isUnique, isRune: isRune, isRuneword: isRuneword, isJewel: isJewel, isStone: isStone, isSuperior: isSuperior, itemClass: itemClass }, (isHelm || isArmor || isBelt || isCape || isShield
        ? { defense: Types.getArmorDefense(item, level, isUnique, isSuperior) }
        : null)), (isWeapon ? { damage: Types.getWeaponDamage(item, level, isUnique, isSuperior) } : null)), { healthBonus: healthBonus, magicDamage: magicDamage, requirement: requirement, description: description, bonus: bonus, socket: rawSocket === null || rawSocket === void 0 ? void 0 : rawSocket.length, partyBonus: partyBonus, runeBonus: runeBonus, runeRank: runeRank, skill: skill, goldAmount: goldAmount });
};
Types.getDisplayName = function (item, isUnique) {
...
Types.itemDescription = {
    skeletonkingcage: "The thoracic cage of the Skeleton King. An unknown magic is still being emitted from the remains. Combined with other ingredients at the anvil, it will open a secret area, lv.45 required to enter",
    necromancerheart: "The heart of the Necromancer. An unknown magic is still being emitted from the remains. . Combined with other ingredients at the anvil, it will open a secret area, lv.45 required to enter",
    ...
    expansion2voucher: "Lost Temple expansion Voucher when consumed in the Anvil the Lost Temple will unlock if you don't already have it.",
    barbronze: "Common metal.",
    barsilver: "Rare metal.",
    bargold: "Precious metal.",
    barplatinum: "Priceless metal.",
    petegg: "An egg of a dinosaur pet with colorful scales and a heart of loyalty, forming a strong bond with you as you explore the world together",
    scrollupgradelow: "Upgrade low class items. The chances for a successful upgrade varies depending on the item's level.",
    scrollupgrademedium: "Upgrade medium class items. The chances for a successful upgrade varies depending on the item's level.",
    scrollupgradehigh: "Upgrade high class item. The chances for a successful upgrade varies depending on the item's level.",
    scrollupgradelegendary: "Upgrade legendary class item. The chances for a successful upgrade varies depending on the item's level.",
    scrollupgradeblessed: "Upgrade high class item. The chances for a successful upgrade varies depending on the item's level. Blessed scrolls gives a higher chance of successful upgrade.",
    scrollupgradesacred: "Upgrade legendary class item. The chances for a successful upgrade varies depending on the item's level. Sacred scrolls gives a higher chance of successful upgrade.",
    scrolltransmute: "Transmute a ring or an amulet and generate new random stats or an item to have a chance of making it unique. The chances of transmuting stats is fixed while the chances of getting a unique varies. There is a 25% chance your item will be burned during the transmutation.",
    scrolltransmuteblessed: "Transmute a ring or an amulet and generate new random stats or an item to have a chance of making it unique. The chances of transmuting stats is fixed while the chances of getting a unique varies. There is a 1% chance your item will be burned during the transmutation.",
    ...
    stonesocket: "Creates a random number of sockets in a non-socketed item. If all sockets are empty, you can re-roll sockets up to 4 on unique items or 3 for normal items<br/><br/>If the item already has sockets, the stone will attempt to remove the last item from its socket. There is 50% chance for the extracting item to be burned.",
    stonesocketblessed: "Creates a random number of sockets in a non-socketed item.  If all sockets are empty, you can re-roll sockets up to 6 on unique items or 5 for normal items.<br/><br/>If the item already has sockets, the stone will attempt to remove the last item from its socket. There is 1% chance for the extracting item to be burned.",
    jewelskull: "Can be inserted in a socket",
    stonedragon: "Blessed by the fire of the dragon, safely upgrade any item to +5",
    stonehero: "You've crushed your enemies, saw them driven before you, and heard the lamentation of their women.<br/>Safely upgrade any item to +6",
    ...
    scrollupgradeskillrandom: "Enchant a  a high or legendary  weapon or shield with a random ability (current ability will be changed or it has a chance to stay unchanged), 99% success",
