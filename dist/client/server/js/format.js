...
var FormatChecker = (function () {
    ...
    FormatChecker.prototype.check = function (json) {
        var action = json.action, message = json.message, params = json.params;
        var messageId = message.message;
        if (!action && action !== 0) {
            return false;
        }
        var filteredParams = params.reduce(function (acc, value) {
            if (value !== null) {
                acc.push(value);
            }
            return acc;
        ...
        if (format) {
            ...
            return (filteredParams.length === 3 &&
                _.isNumber(action) &&
