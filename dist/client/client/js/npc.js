...
import { ACHIEVEMENT_CRYSTAL_INDEX, ACHIEVEMENT_NFT_INDEX, ACHIEVEMENT_WING_INDEX, } from "../../shared/js/types/achievements";
...
var NpcTalk = {
    ...
    hands: [
        {
            condition: function (_game, isActivated) {
                return !isActivated;
            },
            text: [
...
var Npc = (function (_super) {
    ...
    function Npc(id, kind) {
        var _this = _super.call(this, id, kind) || this;
        _this.itemKind = Types.getKindAsString(_this.kind);
        _this.type = "npc";
        _this.isTalkLocked = false;
        if (typeof NpcTalk[_this.itemKind][0] === "string") {
            _this.discourse = -1;
            _this.talkCount = NpcTalk[_this.itemKind].length;
        }
        else {
            _this.discourse = 0;
            _this.talkCount = NpcTalk[_this.itemKind][_this.discourse]["text"].length;
        }
        _this.talkIndex = 0;
        return _this;
    }
    Npc.prototype.selectTalk = function (game) {
        var change = false;
        if (this.discourse != -1) {
            var found = false;
    ...
    Npc.prototype.talk = function (game, talkIndex) {
        var msg = "";
