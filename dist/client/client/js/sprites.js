...
var sprites = {
    ...
    axe: axe,
    blueaxe: blueaxe,
    bluemorningstar: bluemorningstar,
    bat: bat,
    bat2: bat2,
    beachnpc: beachnpc,
    bluesword: bluesword,
    boss: boss,
    skeletoncommander: skeletoncommander,
    chest: chest,
    coder: coder,
    crab: crab,
    death: death,
    ...
    minotaur: minotaur,
    skeleton4: skeleton4,
    skeletonscythe1: skeletonscythe1,
    skeletonaxe1: skeletonaxe1,
    skeletonaxe2: skeletonaxe2,
    golem: golem,
    worm: worm,
    wraith2: wraith2,
    ghost: ghost,
    ...
    "arrow-poison": arrow,
    shaman: shaman,
    skeletontemplar: skeletontemplar,
    skeletontemplar2: skeletontemplar2,
    spider: spider,
    spider2: spider2,
    spiderqueen: spiderqueen,
    butcher: butcher,
    oculothorax: oculothorax,
    kobold: kobold,
    ...
    bluearmor: bluearmor,
    hornedarmor: hornedarmor,
    frozenarmor: frozenarmor,
    diamondarmor: diamondarmor,
    emeraldarmor: emeraldarmor,
    templararmor: templararmor,
    dragonarmor: dragonarmor,
    moonarmor: moonarmor,
    christmasarmor: christmasarmor,
    demonarmor: demonarmor,
    mysticalarmor: mysticalarmor,
    immortalarmor: immortalarmor,
    paladinarmor: paladinarmor,
    goldensword: goldensword,
    frozensword: frozensword,
    diamondsword: diamondsword,
    minotauraxe: minotauraxe,
    emeraldsword: emeraldsword,
    moonsword: moonsword,
    christmassword: christmassword,
    moonhachet: moonhachet,
    christmashachet: christmashachet,
    moonmaul: moonmaul,
    christmasmaul: christmasmaul,
    templarsword: templarsword,
    spikeglaive: spikeglaive,
    eclypsedagger: eclypsedagger,
    demonaxe: demonaxe,
    demonsickle: demonsickle,
    paladinaxe: paladinaxe,
    demonmaul: demonmaul,
    immortaldagger: immortaldagger,
    immortalsword: immortalsword,
    immortalaxe: immortalaxe,
    executionersword: executionersword,
    mysticalsword: mysticalsword,
    mysticaldagger: mysticaldagger,
    dragonsword: dragonsword,
    hellhammer: hellhammer,
    maul: maul,
    wizardsword: wizardsword,
    guard: guard,
    hand: hand,
    impact: impact,
    cape: cape,
    ...
    shieldred: shieldred,
    shieldgolden: shieldgolden,
    shieldblue: shieldblue,
    shieldhorned: shieldhorned,
    shieldfrozen: shieldfrozen,
    shielddiamond: shielddiamond,
    shieldemerald: shieldemerald,
    shieldtemplar: shieldtemplar,
    shieldexecutioner: shieldexecutioner,
    shielddragon: shielddragon,
    shieldmoon: shieldmoon,
    shieldchristmas: shieldchristmas,
    shieldmystical: shieldmystical,
    shielddemon: shielddemon,
    shieldpaladin: shieldpaladin,
    shieldimmortal: shieldimmortal,
    "item-axe": item,
    "item-blueaxe": item,
    ...
    lavanpc: lavanpc,
    helmcloth: helmcloth,
    helmleather: helmleather,
    helmmail: helmmail,
    helmplate: helmplate,
    helmred: helmred,
    helmgolden: helmgolden,
    helmblue: helmblue,
    helmhorned: helmhorned,
    helmfrozen: helmfrozen,
    helmdiamond: helmdiamond,
    helmemerald: helmemerald,
    helmexecutioner: helmexecutioner,
    helmtemplar: helmtemplar,
    helmdragon: helmdragon,
    helmmoon: helmmoon,
    helmchristmas: helmchristmas,
    helmdemon: helmdemon,
    helmmystical: helmmystical,
    helmimmortal: helmimmortal,
    helmpaladin: helmpaladin,
    helmclown: helmclown,
    helmpumkin: helmpumkin,
    ...
    blueflame: blueflame,
    altarchalice: altarchalice,
    altarsoulstone: altarsoulstone,
    secretstairs: secretstairs,
    secretstairs2: secretstairs2,
    secretstairsup: secretstairsup,
    tombdeathangel: tombdeathangel,
    tombangel: tombangel,
    tombcross: tombcross,
    tombskull: tombskull,
    lever: lever,
    ...
    grimoire: grimoire,
    fossil: fossil,
    panelskeletonkey: panelskeletonkey,
    obelisk: obelisk,
    hands: hands,
    alkor: alkor,
    olaf: olaf,
    ...
    villager: villager,
    carlosmatos: carlosmatos,
    janetyellen: janetyellen,
    merchant: merchant,
    satoshi: satoshi,
    wizard: wizard,
};
