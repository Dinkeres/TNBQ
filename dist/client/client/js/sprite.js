...
var Sprite = (function () {
    function Sprite(name, scale, network) {
        ...
        this.offsetY = 0;
        if (!sprites[name]) {
            console.error("Missing sprite: ".concat(name));
        }
        this.loadJSON(sprites[name]);
    }
    Sprite.prototype.loadJSON = function (data) {
        this.id = data.id;
    ...
    Sprite.prototype.load = function () {
        ...
        this.image.onload = function () {
            var _a;
            self.isLoaded = true;
            (_a = self.onload_func) === null || _a === void 0 ? void 0 : _a.call(self);
        };
    };
    ...
    Sprite.prototype.createHurtSprite = function () {
    ...
    Sprite.prototype.getHurtSprite = function () {
        return this.whiteSprite;
    };
    Sprite.prototype.createSilhouette = function () {
        var canvas = document.createElement("canvas"), ctx = canvas.getContext("2d"), width = this.image.width, height = this.image.height, spriteData;
        canvas.width = width;
        canvas.height = height;
        try {
            ctx.drawImage(this.image, 0, 0, width, height);
